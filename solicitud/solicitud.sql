...
) ENGINE=InnoDB AUTO_INCREMENT=158271 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
...
CREATE TABLE `cat_autorizacion` (
  ...
  KEY `pk` (`id_autorizacion`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_correo_promocion` (
  ...
  KEY `pk` (`id_cat_promocion`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_email_remarketing` (
  ...
  KEY `pk` (`id_email_remarketing_cat`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_estatus_curp` (
  ...
  KEY `pk` (`id_estatus_curp`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_estatus_solicitud` (
  ...
  PRIMARY KEY (`id_estatus`),
  KEY `pk` (`id_estatus`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_flag_fraude` (
  ...
  PRIMARY KEY (`id_flag`),
  KEY `pk` (`id_flag`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_grado_estudios` (
  ...
  KEY `pk` (`id_grado_estudios`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_medio_envio_codigo` (
  ...
  KEY `pk` (`id_medio`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2485 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_nivel_estudios` (
  ...
  KEY `pk` (`id_nivel_estudios`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_pais` (
  ...
  KEY `pk` (`id_pais`)
) ENGINE=InnoDB AUTO_INCREMENT=262 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_tipo_credito` (
  ...
  KEY `pk` (`id_tipo_credito`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cat_tipo_vialidad` (
  ...
  KEY `pk` (`id_tipo_vialidad`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `catalogo_ingresos` (
  ...
  KEY `pk` (`id_catalogo`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15949493 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16050963 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2889407 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=307642 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6950670 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2958484 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1224 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_cp_blacklist` (
  ...
  KEY `pk` (`id_cp`),
  KEY `idxCurp` (`cp`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2905601 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2834767 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3523483 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_email_blacklist` (
  ...
  KEY `pk` (`id_email`)
) ENGINE=InnoDB AUTO_INCREMENT=1159 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=45426907 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=49452474 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7879933 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7693077 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='String';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3055410 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2599841 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_origen_ingreso_solicitud` (
  ...
  KEY `pk` (`id_origen_ingreso_prospecto`),
  KEY `fk` (`id_solicitud`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3393480 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3522728 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4400716 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3971266 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4275255 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=54326 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8261798 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9758663 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tbl_workflow_bkp`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_workflow_bkp` (
  `id_workflow` int(11) NOT NULL AUTO_INCREMENT,
  `correo` varchar(100) DEFAULT NULL,
  `id_tipo_workflow` tinyint(4) NOT NULL,
  `id_solicitud` int(11) DEFAULT NULL,
  ...
  KEY `idx_correo` (`correo`),
  KEY `idx_solicitud` (`id_solicitud`),
  CONSTRAINT `fk_tipo_workflow` FOREIGN KEY (`id_tipo_workflow`) REFERENCES `cat_tipo_workflow` (`id_tipo_workflow`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=92548 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='string';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `tbl_workflow_vw`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `tbl_workflow_vw` AS SELECT
 1 AS `id_workflow`,
  1 AS `correo`,
  1 AS `id_tipo_workflow`,
  1 AS `id_solicitud`,
  1 AS `version`,
  1 AS `ultimo`,
  1 AS `fecha_hora`,
  1 AS `id_workflow_version` */;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `tmp_corrige_producto`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `tmp_corrige_producto` (
  `id_solicitud` int(11) NOT NULL,
  `prod_final` tinyint(1) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary table structure for view `vw_analisis_diario_finalizadas_estatus`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_finalizadas_estatus` AS SELECT
 1 AS `hora`,
  1 AS `dia`,
  1 AS `conteoFinalizada`,
  1 AS `diasemana`,
  1 AS `estatus` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_analisis_diario_finalizadas_estatus_promedio`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_finalizadas_estatus_promedio` AS SELECT
 1 AS `diasemana`,
  1 AS `hora`,
  1 AS `estatus`,
  1 AS `PromedioconteoFinalizada` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_analisis_diario_finalizadas_estatus_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_finalizadas_estatus_tablero` AS SELECT
 1 AS `hora`,
  1 AS `diasemana`,
  1 AS `estatus`,
  1 AS `dia`,
...
--
-- Temporary table structure for view `vw_analisis_diario_finalizadas_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_finalizadas_tablero` AS SELECT
 1 AS `hora`,
  1 AS `diasemana`,
  1 AS `dia`,
  1 AS `conteoFinalizada`,
...
--
-- Temporary table structure for view `vw_analisis_diario_iniciadas_estatus_sol_larga`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_iniciadas_estatus_sol_larga` AS SELECT
 1 AS `hora`,
  1 AS `dia`,
  1 AS `diasemana`,
  1 AS `conteoIniciadas`,
  1 AS `estatus`,
  1 AS `solicitud_larga` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_analisis_diario_iniciadas_estatus_sol_larga_promedio`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_iniciadas_estatus_sol_larga_promedio` AS SELECT
 1 AS `hora`,
  1 AS `diasemana`,
  1 AS `estatus`,
  1 AS `solicitud_larga`,
  1 AS `PromedioconteoIniciadas` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_analisis_diario_iniciadas_estatus_sol_larga_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_iniciadas_estatus_sol_larga_tablero` AS SELECT
 1 AS `hora`,
  1 AS `diasemana`,
  1 AS `solicitud_larga`,
  1 AS `dia`,
...
--
-- Temporary table structure for view `vw_analisis_diario_iniciadas_estatus_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_iniciadas_estatus_tablero` AS SELECT
 1 AS `hora`,
  1 AS `diasemana`,
  1 AS `estatus`,
  1 AS `dia`,
...
--
-- Temporary table structure for view `vw_analisis_diario_preiniciadas_por_estatus`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_preiniciadas_por_estatus` AS SELECT
 1 AS `hora`,
  1 AS `dia`,
  1 AS `diasemana`,
  1 AS `dayofweek_num`,
...
--
-- Temporary table structure for view `vw_analisis_diario_preiniciadas_por_estatus_promedio`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_preiniciadas_por_estatus_promedio` AS SELECT
 1 AS `hora`,
  1 AS `diasemana`,
  1 AS `estatus`,
  1 AS `id_cod_ref`,
...
--
-- Temporary table structure for view `vw_analisis_diario_preiniciadas_por_estatus_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_preiniciadas_por_estatus_tablero` AS SELECT
 1 AS `hora`,
  1 AS `diasemana`,
  1 AS `current_estatus`,
  1 AS `cod_ref`,
  1 AS `dia`,
  1 AS `conteoIniciadas`,
  1 AS `PromedioconteoIniciadas` */;
...
--
-- Temporary table structure for view `vw_analisis_diario_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_diario_tablero` AS SELECT
 1 AS `hora`,
  1 AS `diasemana`,
  1 AS `dia`,
  1 AS `conteoIniciadas`,
...
--
-- Temporary table structure for view `vw_analisis_mensual_finalizadas_estatus`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_finalizadas_estatus` AS SELECT
 1 AS `hora`,
  1 AS `mes`,
  1 AS `conteoFinalizada`,
  1 AS `estatus` */;
...
--
-- Temporary table structure for view `vw_analisis_mensual_finalizadas_estatus_previo`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_finalizadas_estatus_previo` AS SELECT
 1 AS `hora`,
  1 AS `mes`,
  1 AS `conteoFinalizada`,
  1 AS `estatus` */;
...
--
-- Temporary table structure for view `vw_analisis_mensual_finalizadas_estatus_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_finalizadas_estatus_tablero` AS SELECT
 1 AS `hora`,
  1 AS `estatus`,
  1 AS `mes`,
  1 AS `conteoFinalizada`,
  1 AS `conteoFinalizadaPromedio` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_analisis_mensual_finalizadas_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_finalizadas_tablero` AS SELECT
 1 AS `hora`,
  1 AS `mes`,
  1 AS `conteoFinalizada`,
  1 AS `conteoFinalizadaPromedio` */;
...
--
-- Temporary table structure for view `vw_analisis_mensual_iniciadas_estatus_sol_larga`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_iniciadas_estatus_sol_larga` AS SELECT
 1 AS `hora`,
  1 AS `mes`,
  1 AS `conteoIniciadas`,
  1 AS `estatus`,
...
--
-- Temporary table structure for view `vw_analisis_mensual_iniciadas_estatus_sol_larga_mes_anterior`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_iniciadas_estatus_sol_larga_mes_anterior` AS SELECT
 1 AS `hora`,
  1 AS `mes`,
  1 AS `conteoIniciadasAnterior`,
  1 AS `estatus`,
  1 AS `solicitud_larga` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_analisis_mensual_iniciadas_estatus_sol_larga_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_iniciadas_estatus_sol_larga_tablero` AS SELECT
 1 AS `hora`,
  1 AS `mes`,
  1 AS `solicitud_larga`,
  1 AS `conteoIniciadas`,
...
--
-- Temporary table structure for view `vw_analisis_mensual_iniciadas_estatus_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_iniciadas_estatus_tablero` AS SELECT
 1 AS `hora`,
  1 AS `mes`,
  1 AS `estatus`,
  1 AS `conteoIniciadas`,
...
--
-- Temporary table structure for view `vw_analisis_mensual_iniciadas_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_mensual_iniciadas_tablero` AS SELECT
 1 AS `hora`,
  1 AS `mes`,
  1 AS `conteoIniciadas`,
  1 AS `conteoIniciadasAnterior` */;
...
--
-- Temporary table structure for view `vw_analisis_promedio_semanal_iniciadas`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_promedio_semanal_iniciadas` AS SELECT
 1 AS `hora`,
  1 AS `PromedioConteoIniciadas` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_analisis_semanal_finalizadas_estatus`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_finalizadas_estatus` AS SELECT
 1 AS `hora`,
  1 AS `semana`,
  1 AS `conteoFinalizada`,
  1 AS `estatus` */;
...
--
-- Temporary table structure for view `vw_analisis_semanal_finalizadas_estatus_promedio`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_finalizadas_estatus_promedio` AS SELECT
 1 AS `hora`,
  1 AS `estatus`,
  1 AS `conteoFinalizadaPromedio` */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vw_analisis_semanal_finalizadas_estatus_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_finalizadas_estatus_tablero` AS SELECT
 1 AS `hora`,
  1 AS `estatus`,
  1 AS `semana`,
  1 AS `FechaInicio`,
...
--
-- Temporary table structure for view `vw_analisis_semanal_finalizadas_estatus_tablero_totales`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_finalizadas_estatus_tablero_totales` AS SELECT
 1 AS `hora`,
  1 AS `semana`,
  1 AS `FechaInicio`,
  1 AS `conteoFinalizada`,
...
--
-- Temporary table structure for view `vw_analisis_semanal_iniciadas`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_iniciadas` AS SELECT
 1 AS `hora`,
  1 AS `semana`,
  1 AS `conteoIniciadas`,
  1 AS `estatus`,
...
--
-- Temporary table structure for view `vw_analisis_semanal_iniciadas_estatus_sol_larga`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_iniciadas_estatus_sol_larga` AS SELECT
 1 AS `hora`,
  1 AS `semana`,
  1 AS `conteoIniciadas`,
  1 AS `estatus`,
...
--
-- Temporary table structure for view `vw_analisis_semanal_iniciadas_estatus_sol_larga_promedio`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_iniciadas_estatus_sol_larga_promedio` AS SELECT
 1 AS `hora`,
  1 AS `solicitud_larga`,
  1 AS `estatus`,
  1 AS `conteoIniciadasPromedio` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_analisis_semanal_iniciadas_estatus_sol_larga_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_iniciadas_estatus_sol_larga_tablero` AS SELECT
 1 AS `hora`,
  1 AS `solicitud_larga`,
  1 AS `semana`,
  1 AS `FechaInicio`,
...
--
-- Temporary table structure for view `vw_analisis_semanal_iniciadas_estatus_tablero`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_iniciadas_estatus_tablero` AS SELECT
 1 AS `hora`,
  1 AS `estatus`,
  1 AS `semana`,
  1 AS `FechaInicio`,
...
--
-- Temporary table structure for view `vw_analisis_semanal_iniciadas_estatus_tablero_totales`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_analisis_semanal_iniciadas_estatus_tablero_totales` AS SELECT
 1 AS `hora`,
  1 AS `semana`,
  1 AS `FechaInicio`,
  1 AS `conteoIniciadas`,
...
--
-- Temporary table structure for view `vw_semanal_dia_inicial`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_semanal_dia_inicial` AS SELECT
 1 AS `semana`,
  1 AS `FechaInicio` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_tablero_solicitud_VLSD`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitud_VLSD` AS SELECT
 1 AS `fecha`,
  1 AS `hora`,
  1 AS `conteoFinalizadas`,
  1 AS `PromedioFinalizadas`,
  1 AS `diaHora + interval horas hour`,
  1 AS `CURRENT_TIMESTAMP()` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_tablero_solicitud_terminada_exitosamente`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitud_terminada_exitosamente` AS SELECT
 1 AS `fecha`,
  1 AS `hora`,
  1 AS `conteoFinalizadas`,
  1 AS `PromedioFinalizadas`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_iniciadas`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_iniciadas` AS SELECT
 1 AS `conteoIniciadas`,
  1 AS `fechaInicio`,
  1 AS `hora`,
  1 AS `PromedioIniciadas`,
  1 AS `diaHora + interval horas hour`,
  1 AS `CURRENT_TIMESTAMP()` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_tablero_solicitudes_iniciadas_cortas_status`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_iniciadas_cortas_status` AS SELECT
 1 AS `solicitud_larga`,
  1 AS `conteoIniciadas`,
  1 AS `fechaInicio`,
  1 AS `hora`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_iniciadas_cortas_status_totales`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_iniciadas_cortas_status_totales` AS SELECT
 1 AS `conteoIniciadas`,
  1 AS `fechaInicio`,
  1 AS `hora`,
  1 AS `PromedioIniciadas`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_iniciadas_mensual`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_iniciadas_mensual` AS SELECT
 1 AS `Mes`,
  1 AS `FechaInicio`,
  1 AS `hora`,
  1 AS `conteoIniciadas`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_iniciadas_semanal`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_iniciadas_semanal` AS SELECT
 1 AS `semana`,
  1 AS `FechaInicio`,
  1 AS `hora`,
  1 AS `conteoIniciadas`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_iniciadas_status_totales`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_iniciadas_status_totales` AS SELECT
 1 AS `conteoIniciadas`,
  1 AS `fechaInicio`,
  1 AS `hora`,
  1 AS `PromedioIniciadas`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_iniciadas_totales`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_iniciadas_totales` AS SELECT
 1 AS `conteoIniciadas`,
  1 AS `fechaInicio`,
  1 AS `hora`,
  1 AS `PromedioIniciadas`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_terminadas`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_terminadas` AS SELECT
 1 AS `fecha`,
  1 AS `hora`,
  1 AS `conteoFinalizadas`,
  1 AS `PromedioFinalizadas`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_terminadas_mensual`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_terminadas_mensual` AS SELECT
 1 AS `mes`,
  1 AS `FechaInicioMes`,
  1 AS `hora`,
  1 AS `id_estatus`,
  1 AS `conteoFinalizadas`,
  1 AS `conteoPromedioFinalizadas` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_tablero_solicitudes_terminadas_mensual_totales`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_terminadas_mensual_totales` AS SELECT
 1 AS `mes`,
  1 AS `FechaInicioMes`,
  1 AS `hora`,
  1 AS `conteoFinalizadas`,
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_terminadas_semanal`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_terminadas_semanal` AS SELECT
 1 AS `semana`,
  1 AS `FechaInicioSemana`,
  1 AS `hora`,
  1 AS `id_estatus`,
  1 AS `conteoFinalizadas`,
  1 AS `conteoPromedioFinalizadas` */;
...
--
-- Temporary table structure for view `vw_tablero_solicitudes_terminadas_semanal_totales`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_tablero_solicitudes_terminadas_semanal_totales` AS SELECT
 1 AS `semana`,
  1 AS `FechaInicioSemana`,
  1 AS `hora`,
  1 AS `conteoFinalizadas`,
...
--
-- Temporary table structure for view `vw_vista_dias_semana_hora`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `vw_vista_dias_semana_hora` AS SELECT
 1 AS `fecha`,
  1 AS `diaHora`,
  1 AS `diasemana`,
  1 AS `hora`,
...
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_poblar_valores`()
BEGIN
